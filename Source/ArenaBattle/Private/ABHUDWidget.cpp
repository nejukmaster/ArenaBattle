...
void UABHUDWidget::BindPlayerState(AABPlayerState* PlayerState) {
	...
	PlayerState->OnPlayerStateChangedDelegate.AddUObject(this, &UABHUDWidget::UpdatePlayerState);
}
...
void UABHUDWidget::UpdatePlayerState() {
	...
	HightScore->SetText(FText::FromString(FString::FromInt(CurrentPlayerState->GetGameHightScore())));
}
